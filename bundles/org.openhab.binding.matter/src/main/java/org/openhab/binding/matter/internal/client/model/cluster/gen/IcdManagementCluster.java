...
Another example is if the MonitoredSubject has the value 0xFFFF_FFFD_AA12_0002, and one of the subscribers to the server on the entry’s associated fabric bears the CASE Authenticated TAG value 0xAA12 and the version 0x0002 or higher within its NOC, then the entry matches.
    ...
    */
    public static class UserActiveModeTriggerBitmap {
        ...
        public UserActiveModeTriggerBitmap(boolean powerCycle, boolean settingsMenu, boolean customInstruction, boolean deviceManual, boolean actuateSensor, boolean actuateSensorSeconds, boolean actuateSensorTimes, boolean actuateSensorLightsBlink, boolean resetButton, boolean resetButtonLightsBlink, boolean resetButtonSeconds, boolean resetButtonTimes, boolean setupButton, boolean setupButtonSeconds, boolean setupButtonLightsBlink, boolean setupButtonTimes, boolean appDefinedButton){
