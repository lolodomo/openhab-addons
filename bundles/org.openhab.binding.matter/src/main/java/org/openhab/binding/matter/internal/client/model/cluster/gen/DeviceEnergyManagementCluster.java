...
It shall contain at least 1 entry, and a maximum of 10.
        ...
        */
        ...
        public ForecastStruct(Integer forecastId, Integer activeSlotNumber, Integer startTime, Integer endTime, Integer earliestStartTime, Integer latestEndTime, Boolean isPauseable, List<SlotStruct> slots, ForecastUpdateReasonEnum forecastUpdateReason) {
...
It does this by sending a RequestConstraintBasedForecast to the EVSE and asks it to run at a higher NominalPower consumption during the constraint period, which may require it to decrease its charge rate outside the constraint period to achieve its required energy demand.
    ...
    */
    public static ClusterCommand modifyForecastRequest(Integer forecastId, List<SlotAdjustmentStruct> slotAdjustments, AdjustmentCauseEnum cause) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    */
    public static ClusterCommand requestConstraintBasedForecast(List<ConstraintsStruct> constraints, AdjustmentCauseEnum cause) {
        Map<String, Object> map = new LinkedHashMap<>();
