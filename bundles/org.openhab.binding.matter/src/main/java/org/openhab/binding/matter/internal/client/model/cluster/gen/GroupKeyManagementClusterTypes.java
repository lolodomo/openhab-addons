...
public class GroupKeyManagementClusterTypes {
    ...
    public static final int CLUSTER_ID = 0x003F;
     ...
     public class GroupInfoMapStruct {
        ...
        public GroupInfoMapStruct(List<Integer> groupId, List<Integer> endpoints, String groupName, Integer fabricIndex) {
     ...
     public class GroupKeySetStruct {
        ...
        public GroupKeySetStruct(Integer groupKeySetID, GroupKeySecurityPolicyEnum groupKeySecurityPolicy, String epochKey0, Long epochStartTime0, String epochKey1, Long epochStartTime1, String epochKey2, Long epochStartTime2) {
            this.groupKeySetID = groupKeySetID;
