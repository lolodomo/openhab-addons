...
public class Pm25ConcentrationMeasurementCluster extends BaseCluster {
    ...
    static {
        ATTRIBUTE_MAPPING = Map.ofEntries(entry(868, "measuredValue"), entry(872, "minMeasuredValue"),
                entry(876, "maxMeasuredValue"), entry(880, "peakMeasuredValue"), entry(884, "peakMeasuredValueWindow"),
                entry(888, "averageMeasuredValue"), entry(893, "averageMeasuredValueWindow"), entry(897, "uncertainty"),
                entry(900, "measurementUnit"), entry(904, "measurementMedium"), entry(909, "levelValue"),
    ...
    public Float measuredValue; // 868 single
    public Float minMeasuredValue; // 872 single
    public Float maxMeasuredValue; // 876 single
    public Float peakMeasuredValue; // 880 single
    public Integer peakMeasuredValueWindow; // 884 elapsed_s
    public Float averageMeasuredValue; // 888 single
    public Integer averageMeasuredValueWindow; // 893 elapsed_s
    public Float uncertainty; // 897 single
    public MeasurementUnitEnum measurementUnit; // 900 MeasurementUnitEnum
    public MeasurementMediumEnum measurementMedium; // 904 MeasurementMediumEnum
    public LevelValueEnum levelValue; // 909 LevelValueEnum
