...
public class ElectricalMeasurementClusterTypes {
    ...
    public static class GetProfileInfoResponseCommandCommandOptions {
        ...
        public GetProfileInfoResponseCommandCommandOptions(Integer profileCount, Integer profileIntervalPeriod,
    ...
    public static class GetMeasurementProfileResponseCommandCommandOptions {
        ...
        public GetMeasurementProfileResponseCommandCommandOptions(Integer startTime, Integer status,
                Integer profileIntervalPeriod, Integer numberOfIntervalsDelivered, Integer attributeId,
                Integer intervals) {
    ...
    public static class GetMeasurementProfileCommandCommandOptions {
        ...
        public GetMeasurementProfileCommandCommandOptions(Integer attributeId, Integer startTime,
