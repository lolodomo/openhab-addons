...
public class WindowCoveringClusterTypes {
    ...
    public static class ConfigStatus {
        ...
        public ConfigStatus(boolean operational, boolean onlineReserved, boolean liftMovementReversed, boolean liftPositionAware, boolean tiltPositionAware, boolean liftEncoderControlled, boolean tiltEncoderControlled){
    ...
    public static class Feature {
        ...
        public Feature(boolean lift, boolean tilt, boolean positionAwareLift, boolean absolutePosition, boolean positionAwareTilt){
            this.lift = lift;
            this.tilt = tilt;
    ...
    public static class Mode {
        ...
        public Mode(boolean motorDirectionReversed, boolean calibrationMode, boolean maintenanceMode, boolean ledFeedback){
    ...
    public static class SafetyStatus {
        ...
        public SafetyStatus(boolean remoteLockout, boolean tamperDetection, boolean failedCommunication, boolean positionFailure, boolean thermalProtection, boolean obstacleDetected, boolean power, boolean stopInput, boolean motorJammed, boolean hardwareFailure, boolean manualOperation, boolean protection){
