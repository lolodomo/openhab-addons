...
This attribute is reported regularly and may be used to control a heating device.
    */
    ...
    /**
    * Indicates the offset the Thermostat server shall make to the measured temperature (locally or remotely) to adjust the Calculated Local Temperature prior to using, displaying or reporting it.
...
If the LocalTemperature RemoteSensing bit is written with a value of 1 when the LTNE feature is present, the write shall fail and the server shall report a CONSTRAINT_ERROR.
    ...
    */
    ...
    /**
    * Indicates the running mode of the thermostat. This attribute uses the same values as SystemModeEnum but can only be Off, Cool or Heat. This attribute is intended to provide additional information when the thermostat’s system mode is in auto mode.
    */
    public ThermostatRunningModeEnum thermostatRunningMode; // 30 ThermostatRunningModeEnum R V
    /**
    * Indicates the day of the week that this thermostat considers to be the start of week for weekly setpoint scheduling.
...
Systems which support cooling or heating, requiring external intervention to change modes or where the whole building must be in the same mode, SHOULD report CoolingOnly or HeatingOnly based on the current capability.
    ...
    */
    ...
    public static class ACErrorCodeBitmap {
        ...
        public ACErrorCodeBitmap(boolean compressorFail, boolean roomSensorFail, boolean outdoorSensorFail, boolean coilSensorFail, boolean fanFail){
  ...
  • 1 &#x3D; Uses fuel
        */
        ...
        public HVACSystemTypeBitmap(boolean coolingStage, boolean heatingStage, boolean heatingIsHeatPump, boolean heatingUsesFuel){
    ...
    public static class RelayStateBitmap {
        ...
        public RelayStateBitmap(boolean heat, boolean cool, boolean fan, boolean heatStage2, boolean coolStage2, boolean fanStage2, boolean fanStage3){
            this.heat = heat;
            this.cool = cool;
            this.fan = fan;
    ...
    public static class ScheduleDayOfWeekBitmap {
        ...
        public boolean away;
        public ScheduleDayOfWeekBitmap(boolean sunday, boolean monday, boolean tuesday, boolean wednesday, boolean thursday, boolean friday, boolean saturday, boolean away){
            this.sunday = sunday;
            this.monday = monday;
    ...
    public static class FeatureMap {
        ...
        */
        public boolean lTNE;
        public FeatureMap(boolean hEAT, boolean cOOL, boolean oCC, boolean sCH, boolean sB, boolean aUTO, boolean lTNE){
            this.hEAT = hEAT;
            this.cOOL = cOOL;
            this.oCC = oCC;
            this.sCH = sCH;
...
The set weekly schedule command is used to update the thermostat weekly setpoint schedule from a management system. If the thermostat already has a weekly setpoint schedule programmed, then it SHOULD replace each daily setpoint set as it receives the updates from the management system. For example, if the thermostat has 4 setpoints for every day of the week and is sent a Set Weekly Schedule command with one setpoint for Saturday then the thermostat SHOULD remove all 4 setpoints for Saturday and replace those with the updated setpoint but leave all other days unchanged. If the schedule is larger than what fits in one frame or contains more than 10 transitions, the schedule shall then be sent using multiple Set Weekly Schedule Commands.
    */
    public static ClusterCommand setWeeklySchedule(Integer numberOfTransitionsForSequence, ScheduleDayOfWeekBitmap dayOfWeekForSequence, ScheduleModeBitmap modeForSequence, List<WeeklyScheduleTransitionStruct> transitions) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    */
    public static ClusterCommand getWeeklySchedule(ScheduleDayOfWeekBitmap daysToReturn, ScheduleModeBitmap modeToReturn) {
        Map<String, Object> map = new LinkedHashMap<>();
