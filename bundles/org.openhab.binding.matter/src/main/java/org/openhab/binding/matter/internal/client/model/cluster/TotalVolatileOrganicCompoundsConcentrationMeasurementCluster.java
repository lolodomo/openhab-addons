...
public class TotalVolatileOrganicCompoundsConcentrationMeasurementCluster extends BaseCluster {
    ...
    public static final String CLUSTER_NAME = "TVOC_CONCENTRATION_MEASUREMENT_CLUSTER";
    public static final int CLUSTER_ID = 0x042E;

    static {
        ATTRIBUTE_MAPPING = Map.ofEntries(entry(994, "measuredValue"), entry(996, "minMeasuredValue"),
                entry(998, "maxMeasuredValue"), entry(1000, "peakMeasuredValue"),
                entry(1002, "peakMeasuredValueWindow"), entry(1004, "averageMeasuredValue"),
                entry(1006, "averageMeasuredValueWindow"), entry(1009, "uncertainty"), entry(1011, "measurementUnit"),
                entry(1014, "measurementMedium"), entry(1016, "levelValue"), entry(13, "generatedCommandList"),
    ...
    public Float measuredValue; // 994 single
    public Float minMeasuredValue; // 996 single
    public Float maxMeasuredValue; // 998 single
    public Float peakMeasuredValue; // 1000 single
    public Integer peakMeasuredValueWindow; // 1002 elapsed_s
    public Float averageMeasuredValue; // 1004 single
    public Integer averageMeasuredValueWindow; // 1006 elapsed_s
    public Float uncertainty; // 1009 single
    public MeasurementUnitEnum measurementUnit; // 1011 MeasurementUnitEnum
    public MeasurementMediumEnum measurementMedium; // 1014 MeasurementMediumEnum
    public LevelValueEnum levelValue; // 1016 LevelValueEnum
    ...
    public TotalVolatileOrganicCompoundsConcentrationMeasurementCluster(long nodeId, int endpointId) {
        super(nodeId, endpointId, 107, "TotalVolatileOrganicCompoundsConcentrationMeasurement");
    }
