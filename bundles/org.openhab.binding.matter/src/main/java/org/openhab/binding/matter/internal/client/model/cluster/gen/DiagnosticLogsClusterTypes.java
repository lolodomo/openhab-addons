...
public class DiagnosticLogsClusterTypes {
    ...
    public static class RetrieveLogsRequestCommandOptions {
        ...
        public RetrieveLogsRequestCommandOptions(IntentEnum intent, TransferProtocolEnum requestedProtocol,
    ...
    public static class RetrieveLogsResponseCommandOptions {
        ...
        public RetrieveLogsResponseCommandOptions(StatusEnum status, String logContent, Long UTCTimeStamp,
                Long timeSinceBoot) {
            this.status = status;
