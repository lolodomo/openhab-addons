  ...
  • The value of the ExecuteIfOff bit is 0.
    ...
    */
    public static class ColorCapabilities {
        ...
        public ColorCapabilities(boolean hueSaturation, boolean enhancedHue, boolean colorLoop, boolean xY, boolean colorTemperature){
...
The UpdateStartHue sub-field is 1 bit in length and specifies whether the device shall update the ColorLoopStartEnhancedHue attribute with the StartHue field. If this sub-field is set to 1, the device shall update the value of the ColorLoopStartEnhancedHue attribute with the value of the StartHue field. If this sub-field is set to 0, the device shall ignore the StartHue field.
    */
    public static class UpdateFlags {
        ...
        public UpdateFlags(boolean updateAction, boolean updateDirection, boolean updateTime, boolean updateStartHue, boolean reserved){
    ...
    //commands
    public static ClusterCommand moveToHue(Integer hue, Direction direction, Integer transitionTime, Options optionsMask, Options optionsOverride) {
    ...
    public static ClusterCommand moveHue(MoveMode moveMode, Integer rate, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    public static ClusterCommand stepHue(StepMode stepMode, Integer stepSize, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    public static ClusterCommand moveToSaturation(Integer saturation, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    public static ClusterCommand moveSaturation(MoveMode moveMode, Integer rate, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("moveMode", moveMode);
        map.put("rate", rate);
        map.put("optionsMask", optionsMask);
    ...
    public static ClusterCommand stepSaturation(StepMode stepMode, Integer stepSize, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("stepMode", stepMode);
        map.put("stepSize", stepSize);
        map.put("transitionTime", transitionTime);
    ...
    public static ClusterCommand moveToHueAndSaturation(Integer hue, Integer saturation, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("hue", hue);
        map.put("saturation", saturation);
        map.put("transitionTime", transitionTime);
    ...
    public static ClusterCommand moveToColor(Integer colorX, Integer colorY, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    public static ClusterCommand stepColor(Integer stepX, Integer stepY, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("stepX", stepX);
        map.put("stepY", stepY);
        map.put("transitionTime", transitionTime);
    ...
    public static ClusterCommand moveToColorTemperature(Integer colorTemperatureMireds, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    */
    public static ClusterCommand enhancedMoveToHue(Integer enhancedHue, Direction direction, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    */
    public static ClusterCommand enhancedMoveHue(MoveMode moveMode, Integer rate, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("moveMode", moveMode);
        map.put("rate", rate);
        map.put("optionsMask", optionsMask);
    ...
    */
    public static ClusterCommand enhancedStepHue(StepMode stepMode, Integer stepSize, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("stepMode", stepMode);
        map.put("stepSize", stepSize);
        map.put("transitionTime", transitionTime);
    ...
    */
    public static ClusterCommand enhancedMoveToHueAndSaturation(Integer enhancedHue, Integer saturation, Integer transitionTime, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("enhancedHue", enhancedHue);
        map.put("saturation", saturation);
        map.put("transitionTime", transitionTime);
    ...
    */
    public static ClusterCommand colorLoopSet(UpdateFlags updateFlags, Integer action, Integer direction, Integer time, Integer startHue, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
...
NOTE the StopMoveStep command has no effect on an active color loop.
    ...
    */
    public static ClusterCommand moveColorTemperature(MoveMode moveMode, Integer rate, Integer colorTemperatureMinimumMireds, Integer colorTemperatureMaximumMireds, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("moveMode", moveMode);
        map.put("rate", rate);
    ...
    */
    public static ClusterCommand stepColorTemperature(StepMode stepMode, Integer stepSize, Integer transitionTime, Integer colorTemperatureMinimumMireds, Integer colorTemperatureMaximumMireds, Options optionsMask, Options optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("stepMode", stepMode);
        map.put("stepSize", stepSize);
        map.put("transitionTime", transitionTime);
