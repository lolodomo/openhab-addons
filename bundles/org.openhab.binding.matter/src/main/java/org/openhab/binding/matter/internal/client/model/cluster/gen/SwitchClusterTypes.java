...
public class SwitchClusterTypes {
    ...
    public static class Feature {
        ...
        public Feature(boolean latchingSwitch, boolean momentarySwitch, boolean momentarySwitchRelease, boolean momentarySwitchLongPress, boolean momentarySwitchMultiPress){
