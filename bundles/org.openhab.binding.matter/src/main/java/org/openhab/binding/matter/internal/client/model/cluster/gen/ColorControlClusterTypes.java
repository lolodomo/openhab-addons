...
public class ColorControlClusterTypes {
    ...
    public static class MoveToHueCommandOptions {
        ...
        public MoveToHueCommandOptions(Integer hue, HueDirection direction, Integer transitionTime,
    ...
    public static class MoveHueCommandOptions {
        ...
        public MoveHueCommandOptions(HueMoveMode moveMode, Integer rate, Map<String, Boolean> optionsMask,
    ...
    public static class StepHueCommandOptions {
        ...
        public StepHueCommandOptions(HueStepMode stepMode, Integer stepSize, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
    ...
    public static class MoveToSaturationCommandOptions {
        ...
        public MoveToSaturationCommandOptions(Integer saturation, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
    ...
    public static class MoveSaturationCommandOptions {
        ...
        public MoveSaturationCommandOptions(SaturationMoveMode moveMode, Integer rate, Map<String, Boolean> optionsMask,
                Map<String, Boolean> optionsOverride) {
            this.moveMode = moveMode;
            this.rate = rate;
            this.optionsMask = optionsMask;
    ...
    public static class StepSaturationCommandOptions {
        ...
        public StepSaturationCommandOptions(SaturationStepMode stepMode, Integer stepSize, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.stepMode = stepMode;
            this.stepSize = stepSize;
            this.transitionTime = transitionTime;
    ...
    public static class MoveToHueAndSaturationCommandOptions {
        ...
        public MoveToHueAndSaturationCommandOptions(Integer hue, Integer saturation, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.hue = hue;
            this.saturation = saturation;
            this.transitionTime = transitionTime;
    ...
    public static class MoveToColorCommandOptions {
        ...
        public MoveToColorCommandOptions(Integer colorX, Integer colorY, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.colorX = colorX;
            this.colorY = colorY;
            this.transitionTime = transitionTime;
    ...
    public static class MoveColorCommandOptions {
        ...
        public MoveColorCommandOptions(Integer rateX, Integer rateY, Map<String, Boolean> optionsMask,
                Map<String, Boolean> optionsOverride) {
            this.rateX = rateX;
            this.rateY = rateY;
            this.optionsMask = optionsMask;
    ...
    public static class StepColorCommandOptions {
        ...
        public StepColorCommandOptions(Integer stepX, Integer stepY, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.stepX = stepX;
            this.stepY = stepY;
            this.transitionTime = transitionTime;
    ...
    public static class MoveToColorTemperatureCommandOptions {
        ...
        public MoveToColorTemperatureCommandOptions(Integer colorTemperatureMireds, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
    ...
    public static class EnhancedMoveToHueCommandOptions {
        ...
        public EnhancedMoveToHueCommandOptions(Integer enhancedHue, HueDirection direction, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.enhancedHue = enhancedHue;
            this.direction = direction;
            this.transitionTime = transitionTime;
    ...
    public static class EnhancedMoveHueCommandOptions {
        ...
        public EnhancedMoveHueCommandOptions(HueMoveMode moveMode, Integer rate, Map<String, Boolean> optionsMask,
                Map<String, Boolean> optionsOverride) {
            this.moveMode = moveMode;
            this.rate = rate;
            this.optionsMask = optionsMask;
    ...
    public static class EnhancedStepHueCommandOptions {
        ...
        public EnhancedStepHueCommandOptions(HueStepMode stepMode, Integer stepSize, Integer transitionTime,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.stepMode = stepMode;
            this.stepSize = stepSize;
            this.transitionTime = transitionTime;
    ...
    public static class EnhancedMoveToHueAndSaturationCommandOptions {
        ...
        public EnhancedMoveToHueAndSaturationCommandOptions(Integer enhancedHue, Integer saturation,
    ...
    public static class ColorLoopSetCommandOptions {
        ...
        public ColorLoopSetCommandOptions(ColorLoopUpdateFlags updateFlags, ColorLoopAction action,
    ...
    public static class MoveColorTemperatureCommandOptions {
        ...
        public MoveColorTemperatureCommandOptions(HueMoveMode moveMode, Integer rate,
    ...
    public static class StepColorTemperatureCommandOptions {
        ...
        public StepColorTemperatureCommandOptions(HueStepMode stepMode, Integer stepSize, Integer transitionTime,
                Integer colorTemperatureMinimumMireds, Integer colorTemperatureMaximumMireds,
                Map<String, Boolean> optionsMask, Map<String, Boolean> optionsOverride) {
            this.stepMode = stepMode;
            this.stepSize = stepSize;
