...
XPAN ID is a big-endian 64-bit unsigned number, represented on the first 8 octets of the octet string.
    ...
    */
     public class WiFiInterfaceScanResultStruct {
        ...
        */
        ...
        public WiFiInterfaceScanResultStruct(WiFiSecurityBitmap security, String ssid, String bssid, Integer channel, WiFiBandEnum wiFiBand, Integer rssi) {
    ...
    */
    public static class WiFiSecurityBitmap {
        ...
        public WiFiSecurityBitmap(boolean unencrypted, boolean wep, boolean wpaPersonal, boolean wpa2Personal, boolean wpa3Personal){
...
The valid combinations of capabilities are restricted and dependent on Thread version.
    */
    public static class ThreadCapabilitiesBitmap {
        ...
        public ThreadCapabilitiesBitmap(boolean isBorderRouterCapable, boolean isRouterCapable, boolean isSleepyEndDeviceCapable, boolean isFullThreadDevice, boolean isSynchronizedSleepyEndDeviceCapable){
...
If the Networks attribute does not contain an entry with the same NetworkID as the one provided in the OperationalDataset, the operation shall be considered an addition, otherwise, it shall be considered an update.
    */
    ...
    /**
    * This command shall remove the network configuration from the Cluster if there was already a network configuration with the same NetworkID. The relative order of the entries in the Networks
