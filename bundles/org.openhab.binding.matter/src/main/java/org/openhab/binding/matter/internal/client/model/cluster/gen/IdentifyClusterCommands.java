...
public class IdentifyClusterCommands {
    ...
    public static ClusterCommand identify(Integer identifyTime) {
        return new ClusterCommand("identify", new IdentifyCommandOptions(identifyTime));
    }

    public static ClusterCommand triggerEffect(EffectIdentifierEnum effectIdentifier, EffectVariantEnum effectVariant) {
        return new ClusterCommand("triggerEffect", new TriggerEffectCommandOptions(effectIdentifier, effectVariant));
    }
}
