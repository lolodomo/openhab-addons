...
public class GeneralDiagnosticsClusterTypes {
    ...
    public static final int CLUSTER_ID = 0x0033;
     ...
     public class NetworkInterface {
        ...
        public NetworkInterface(String name, Boolean isOperational, Boolean offPremiseServicesReachableIPv4, Boolean offPremiseServicesReachableIPv6, String hardwareAddress, String IPv4Addresses, String IPv6Addresses, InterfaceTypeEnum type) {
            this.name = name;
