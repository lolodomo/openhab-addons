...
public class LevelControlClusterTypes {
    ...
    public static class MoveToLevelCommandOptions {
        ...
        public MoveToLevelCommandOptions(Integer level, Integer transitionTime, OptionsBitmap optionsMask,
    ...
    public static class MoveCommandOptions {
        ...
        public MoveCommandOptions(MoveModeEnum moveMode, Integer rate, OptionsBitmap optionsMask,
                OptionsBitmap optionsOverride) {
    ...
    public static class StepCommandOptions {
        ...
        public StepCommandOptions(StepModeEnum stepMode, Integer stepSize, Integer transitionTime,
    ...
    public static class MoveToLevelWithOnOffCommandOptions {
        ...
        public MoveToLevelWithOnOffCommandOptions(Integer level, Integer transitionTime, OptionsBitmap optionsMask,
                OptionsBitmap optionsOverride) {
            this.level = level;
            this.transitionTime = transitionTime;
            this.optionsMask = optionsMask;
    ...
    public static class MoveWithOnOffCommandOptions {
        ...
        public MoveWithOnOffCommandOptions(MoveModeEnum moveMode, Integer rate, OptionsBitmap optionsMask,
                OptionsBitmap optionsOverride) {
            this.moveMode = moveMode;
            this.rate = rate;
            this.optionsMask = optionsMask;
    ...
    public static class StepWithOnOffCommandOptions {
        ...
        public StepWithOnOffCommandOptions(StepModeEnum stepMode, Integer stepSize, Integer transitionTime,
                OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
            this.stepMode = stepMode;
            this.stepSize = stepSize;
            this.transitionTime = transitionTime;
