...
public class FormaldehydeConcentrationMeasurementCluster extends BaseCluster {
    ...
    public static final String CLUSTER_NAME = "FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER";
    public static final int CLUSTER_ID = 0x042B;

    static {
        ATTRIBUTE_MAPPING = Map.ofEntries(entry(912, "measuredValue"), entry(915, "minMeasuredValue"),
                entry(918, "maxMeasuredValue"), entry(921, "peakMeasuredValue"), entry(924, "peakMeasuredValueWindow"),
                entry(927, "averageMeasuredValue"), entry(930, "averageMeasuredValueWindow"), entry(933, "uncertainty"),
                entry(936, "measurementUnit"), entry(939, "measurementMedium"), entry(942, "levelValue"),
    ...
    public Float measuredValue; // 912 single
    public Float minMeasuredValue; // 915 single
    public Float maxMeasuredValue; // 918 single
    public Float peakMeasuredValue; // 921 single
    public Integer peakMeasuredValueWindow; // 924 elapsed_s
    public Float averageMeasuredValue; // 927 single
    public Integer averageMeasuredValueWindow; // 930 elapsed_s
    public Float uncertainty; // 933 single
    public MeasurementUnitEnum measurementUnit; // 936 MeasurementUnitEnum
    public MeasurementMediumEnum measurementMedium; // 939 MeasurementMediumEnum
    public LevelValueEnum levelValue; // 942 LevelValueEnum
    ...
    public FormaldehydeConcentrationMeasurementCluster(long nodeId, int endpointId) {
        super(nodeId, endpointId, 104, "FormaldehydeConcentrationMeasurement");
    }
