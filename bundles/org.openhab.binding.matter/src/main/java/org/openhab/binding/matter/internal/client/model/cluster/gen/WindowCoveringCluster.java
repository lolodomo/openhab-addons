...
public class WindowCoveringCluster extends BaseCluster {
    ...
    */
    ...
    /**
    * Indicates the total number of lift/slide actuations applied to the window covering since the device was installed.
    */
...
In the case a device does not support or implement a specific mode, e.g. the device has a specific installation method and reversal is not relevant or the device does not include a maintenance mode, any write interaction to the Mode attribute, with an unsupported mode bit or any out of bounds bits set, must be ignored and a response containing the status of CONSTRAINT_ERROR will be returned.
  ...
  • 1 &#x3D; Encoder Controlled
        */
        ...
        public ConfigStatusBitmap(boolean operational, boolean onlineReserved, boolean liftMovementReversed, boolean liftPositionAware, boolean tiltPositionAware, boolean liftEncoderControlled, boolean tiltEncoderControlled){
  ...
  • 1 &#x3D; LEDs will display feedback
        */
        ...
        public ModeBitmap(boolean motorDirectionReversed, boolean calibrationMode, boolean maintenanceMode, boolean ledFeedback){
  ...
  • 11b &#x3D; Reserved
    */
    public static class OperationalStatusBitmap {
        ...
        */
        public boolean tilt;
        public OperationalStatusBitmap(boolean global, boolean lift, boolean tilt){
            this.global = global;
            this.lift = lift;
            this.tilt = tilt;
        }
    ...
    public static class SafetyStatusBitmap {
        ...
        public SafetyStatusBitmap(boolean remoteLockout, boolean tamperDetection, boolean failedCommunication, boolean positionFailure, boolean thermalProtection, boolean obstacleDetected, boolean power, boolean stopInput, boolean motorJammed, boolean hardwareFailure, boolean manualOperation, boolean protection){
