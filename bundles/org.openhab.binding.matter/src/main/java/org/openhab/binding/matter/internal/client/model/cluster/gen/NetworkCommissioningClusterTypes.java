...
public class NetworkCommissioningClusterTypes {
    ...
    public static final int CLUSTER_ID = 0x0031;
     ...
     public class NetworkInfoStruct {
        ...
        public NetworkInfoStruct(String networkID, Boolean connected, String networkIdentifier, String clientIdentifier) {
    ...
    public static class Feature {
        ...
        public Feature(boolean wiFiNetworkInterface, boolean threadNetworkInterface, boolean ethernetNetworkInterface, boolean perDeviceCredentials){
    ...
    public static class WiFiSecurityBitmap {
        ...
        public WiFiSecurityBitmap(boolean unencrypted, boolean wep, boolean wpaPersonal, boolean wpa2Personal, boolean wpa3Personal, boolean wpa3MatterPdc){
    ...
    public static class ScanNetworksResponseCommandOptions {
        ...
        public  ScanNetworksResponseCommandOptions(NetworkCommissioningStatusEnum networkingStatus, String debugText, WiFiInterfaceScanResultStruct[] wiFiScanResults, ThreadInterfaceScanResultStruct[] threadScanResults){
    ...
    public static class AddOrUpdateWiFiNetworkCommandOptions {
        ...
        public  AddOrUpdateWiFiNetworkCommandOptions(String ssid, String credentials, Long breadcrumb, String networkIdentity, String clientIdentifier, String possessionNonce){
            this.ssid = ssid;
    ...
    public static class NetworkConfigResponseCommandOptions {
        ...
        public  NetworkConfigResponseCommandOptions(NetworkCommissioningStatusEnum networkingStatus, String debugText, Integer networkIndex, String clientIdentity, String possessionSignature){
            this.networkingStatus = networkingStatus;
            this.debugText = debugText;
    ...
    public static class ConnectNetworkResponseCommandOptions {
        ...
        public  ConnectNetworkResponseCommandOptions(NetworkCommissioningStatusEnum networkingStatus, String debugText, Integer errorValue){
            this.networkingStatus = networkingStatus;
            this.debugText = debugText;
